import { getColor, grayScale } from '@utils/colors';
...
export function Timer({ countdown, style }: TimerProps): JSX.Element {
  ...
  return (
    <Svg width="123" height="108">
      <G transform="translate(16 17)" id="pointers">
        <Rect width="1.393" height="3.214" x="44.85" fill="#00A8CC" rx=".697" />
        <Path
      ...
      <Text fill={getColor('primary')} fontSize={32} x={45} y={75}>
        {timeInSeconds}
      </Text>
    </Svg>
  );
